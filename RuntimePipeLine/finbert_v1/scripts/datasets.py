...
train.to_csv('data/sentiment_data/train.csv', index=False)
test.to_csv('data/sentiment_data/test.csv', index=False)
valid.to_csv('data/sentiment_data/validation.csv', index=False)